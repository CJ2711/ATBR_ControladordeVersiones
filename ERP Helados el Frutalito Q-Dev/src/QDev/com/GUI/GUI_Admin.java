...
public class GUI_Admin extends javax.swing.JFrame {
     ...
     */
    public GUI_Admin(Person person) { //Duda si los debo poner aquí también (cBD, person)
        initComponents();
        this.person = person;
    ...
    private void btn_AdministrarUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AdministrarUsuariosActionPerformed
        ...
        if (GUI_AdministrarUsuarios == null) {
            this.dispose();
            GUI_AdministrarUsuarios = new GUI_UserManagement(person);
        }
    ...
    private void btn_ProduccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ProduccionActionPerformed
        ...
        if (GUI_AdministrarProduccion == null) {
            this.dispose();
            GUI_AdministrarProduccion = new GUI_Production(person);
        }
    ...
    private void btn_PedidoMateriaPrimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_PedidoMateriaPrimaActionPerformed
        ...
        if (GUI_PedidoMateriaPrima == null) {
            this.dispose();
            GUI_PedidoMateriaPrima = new GUI_RawMaterial(person);
        }
